    ...
    <section id="about" class="py-4">
        <div class="container">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        <h1 class="mb-0">Copy Star</h1>
                        <small class="text-muted"><strong>Печать - как Ctrl+C -> Ctrl+V!</strong></small>
                    </div>

                    <div class="mb-2">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente dolorum tenetur ex facere dolor sint explicabo minima quis quia eius voluptas nesciunt, recusandae, modi illum commodi! Dolore inventore assumenda temporibus. Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis est inventore molestias libero ut facilis quos, quas esse quibusdam dicta quidem provident animi unde corrupti. Rerum, magnam? Velit, ullam repellat! Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur doloremque consequuntur ducimus id corporis doloribus laborum soluta facilis deserunt obcaecati labore veniam, sapiente laboriosam neque vero ipsa laudantium quidem nisi?
                    </div>
                    <h4>Пример нашего ассортимента</h4>
                    <!-- Примеры продуктов -->
                    <section id="productExamples" class="bg-light py-3">
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
                                    <div id="carouselExampleIndicators" class="carousel carousel-dark slide" data-bs-ride="true">
                                        ...
                                        <div class="carousel-inner">
                                            <!-- Команда достающая данные из БД -->
                                            <?php
                                                include("db_interact/carousel_cards.php");
                                            ?>
                                        </div>
                                    </div>
                                    <h3 class="pt-2 d-flex justify-content-center">Приходите  за инструментами именно к нам!</h3>
                                </div>
                            </div>
                        </div>
                    </section>
