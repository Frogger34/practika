            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a href="panel_main.php" class="nav-link text-white" aria-current="page">
                                Заказы <span class="badge text-bg-primary">0</span>
                            </a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-2 col-3">
                    <h3>Товары <span class="badge text-bg-primary" id="item-num"></span></h3>                   
                </div>
                <div class="col-1 mb-md-2">
                    <a href="item_add.php" class="btn btn-primary btn-sm">Добавить</a>
                </div>
            </div>
            <div class="bg-white shadow-sm rounded p-4">
                <div class="scroll-table">
                    ...
                    <?php
                        include("../shop/db_interact/list_items.php")
                    ?>
