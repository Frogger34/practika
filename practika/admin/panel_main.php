...
<body class="bg-light">
    ...
    <main class="orders py-4">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h3>Список всех заказов<span class="badge text-bg-primary ms-2">0</span></h3>
                </div>
            </div>
            <div class="bg-white shadow-sm rounded p-4">
                <div class="scroll-table">
                    <div class="row mb-3 align-items-center">
                        <div class="col-1 d-xl-block d-none text-center">
                            <strong>№</strong>
                        </div>
                        ...
                        <div class="col-sm-3 col-4 text-xl-center text-lg-start">
                            <strong>ФИО заказчика</strong>
                        </div>

                        <div class="col-sm-2 d-sm-block d-none text-center">
                    ...
                    <div class="row mb-2 align-items-center">
                        <div class="col-1 text-center d-xl-block d-none">
                            1
                        </div>

                        <div class="col-lg-2 col-4">
                            <strong>26.10.2022 <small class="d-sm-block d-none">12:45</small></strong>
                        </div>

                        <div class="col-sm-3 col-4 text-xl-center text-start">
                        ...
                        <div class="col-lg-1 col-md-12 mt-lg-0 mt-3 text-center">
                            <a href="order.php" class="btn btn-primary btn-sm">Просмотреть</a>
                        </div>
                    </div>
