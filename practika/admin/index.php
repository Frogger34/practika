        ...
        <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #417cbf;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <a href="panel_main.php" target="_blank" class="btn btn-success me-2 <?= $show_opt_admin ?>">Панель админа</a>
                    <a href="../shop/cart.php" class="btn btn-primary me-2 <?= $_SESSION['adminTrue'] ? $show_opt_admin : $show_opt ?>">Корзина</a>
                    <a href="../shop/my_orders.php" class="btn btn-primary me-2 <?= $_SESSION['adminTrue'] ? $show_opt_admin : $show_opt ?>">Мои заказы</a>
