                ...
                <div class="scroll-table">
                    <div class="row">
                        <div class="col-6">
                            <div class="row">
                                <div class="col-12">
                                    <h5><strong>Наименование: NEWART GC-20<span class="badge bg-danger ms-2">Бельгия</span></strong></h5>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="col-2 text-center mb-3">
                                        <img src="../img/1.jpeg" height="200" alt="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 bg-light border border-secondary border-opacity-25 rounded p-3">
                                <p class="mb-1"><strong>Страна-производитель: </strong>Бельгия</p>
                                <p class="mb-1"><strong>Год выпуска: </strong>2005</p>
                                <p class="mb-1"><strong>Модель: </strong>GC-20</p>                          
                                <p class="mb-0"><strong>Цена: </strong>5000 руб.</p>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="row">
                                <div class="col-12">
                                    <h5><strong>Изменение товара</strong></h5>
                                </div>
                            </div>
                            ...
                            <form method="post" class="mb-2">
                                ...
                                <div class="row mb-3">
                                    <div class="col-4">
                                        <strong>Изменить изображение</strong>
                                    </div>
                                    <div class="col-8">
                                ...
                                <button type="submit" class="btn btn-primary mt-2">Потвердить изменения</button>
                            </form>     
                            <form method="post">
